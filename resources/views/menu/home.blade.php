...
@section('cuerpo')
    ...
    <section class="contenedor-viajes">
        <div class="titulo-seccion">
            <h1>Items Principales Viajes Del Peru</h1>
        </div>
        <hr>
        <article>
                    ...
                    <div class="card-body">
                        <div class="card-titulo-content">
                            <h5 class="card-title">{{ $item->nombre }} </h5> <span class="message orange">Anulacion
                                gratis</span><br>
                            <span class="message green">Aun disponible</span> <span class="message red">{{ $item->estado }}
                            </span>
                        </div>
                        <p class="card-body" style="overflow: hidden; height: 110px;" cols="5">{{ $item->descripcion }}</p>
                        <a href="{{route('viajes.info', $item->id)}}" class="btn btn-primary col-6 float-end mt-3">Ver Mas</a>
                    </div>
                </div>
            @endforeach
        </article>
